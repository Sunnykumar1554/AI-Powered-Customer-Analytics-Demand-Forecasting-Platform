...
def load_inventory_data():
    ...
    # Simulate current stock levels with deterministic random seed
    np.random.seed(42)
    ...
    # Calculate stock ratios and status
...
if df_inv is not None:
    ...
    # Select top 15 highest risk (lowest stock ratio) products
    ...
    # Let's apply pandas coloring based on status
